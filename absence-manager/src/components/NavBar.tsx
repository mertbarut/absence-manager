...
export default function NavBar() {
  return (
    <div>
      <nav className="flex items-center justify-between flex-wrap bg-gradient-to-r from-blue-500 to-cyan-500 p-6">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <span className="font-semibold text-xl text-slate-300 tracking-tight">Absence Manager App</span>
        </div>
      </nav>
    </div>
  )
